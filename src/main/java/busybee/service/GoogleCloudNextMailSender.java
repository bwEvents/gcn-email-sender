...
public class GoogleCloudNextMailSender {
    ...
    public EmailSentInfo sendMail(String invitee, String invitationLink,String supportEmail,String emailTo,String sponsorPassType, boolean cancel) {
        log.info("Sending mail");
        try {

            MimeMessage message = createMessageFrom(invitee,invitationLink,supportEmail,emailTo,sponsorPassType, cancel);
    ...
    private MimeMessage createMessageFrom(String invitee, String invitationLink, String supportEmail, String emailTo,String sponsorPassType, boolean cancel) throws MessagingException, UnsupportedEncodingException {
        ...
        helper.setSubject(getSubjectFrom(invitee, cancel));
        helper.setText(getBodyFrom(invitee,invitationLink,supportEmail,sponsorPassType, cancel),true);
        return mimeMailMessage;
    }

    private String getBodyFrom(String invitee, String invitationLink, String supportEmail,String sponsorPassType, boolean cancel) {
        ...
        if (cancel)
        {
            return "<div style=\"font-family:'Helvetica Neue','Helvetica','Arial',sans-serif;font-size:14px;color:#333\">\n" +
                    ...
                    "<td align=\"center\">\n" +
                    "            \n" +
                    "                <div style=\"color:#333333;display:none;font-size:1px;line-height:1px;max-height:0;max-width:0;opacity:0;overflow:hidden\">Your invitation from "+invitee+" to register for Google Cloud Next '23 has been cancelled</div>\n" +
                    ...
                    "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody><tr>\n" +
                    "<td>\n" +
                    "            <h3><span style=\"font-size:18px\">Your invitation from "+invitee+" to register for a "+sponsorPassType+" at Google Cloud Next '23 has been cancelled.</span></h3>        </td>\n" +
                    "    </tr></tbody></table>\n" +
                    ...
                    "<table width=\"100%\" cellspacing=\"0\" cellpadding=\"0\" border=\"0\"><tbody><tr>\n" +
                    "<td>\n" +
                    "<p style=\"margin-top:0;margin-bottom:10px\">If you believe this to be in error, please email your company's sponsor manager. If you would still like to register for the event as a general attendee, please Click <a href=\""+invitationLink+"\" target=\"_blank\" data-saferedirecturl=\"https://www.google.com/url?q="+invitationLink+"\">here</a>.</p>\n" +
                    "\n" +
                    "<p style=\"margin-top:0;margin-bottom:10px\">Thank you for your continued support and success as a Google Cloud partner.</p>\n" +
                    "\n" +
    ...
    private String getSubjectFrom(String invitee, boolean cancel) {
        if (cancel)
            return "Your invitation from " + invitee + " to register for Google Cloud Next '23 has been cancelled";
